#include "lib/fixpoint_1714.h"
#include <stdint.h>

/* Converts an integer to a 17.14 fixed-point number. */
int
int_to_fixpoint_1714 (int n)
{
    return n * F;
}
...
int
fixpoint_1714_to_int_zero (int x, int y)
{
    return x / F;
}
...
int
fixpoint_1714_add_int (int x, int n)
{
    return x + n * F;
}
...
int
fixpoint_1714_sub_int (int x, int n)
{
    return x - n * F;
}
...
int
fixpoint_1714_mul_int (int x, int n)
{
    return x * n;
}
...
int
fixpoint_1714_div_int (int x, int n)
{
    return x / n;
}